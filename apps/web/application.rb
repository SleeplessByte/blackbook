...
module Web
  class Application < Lotus::Application
    configure do
      ...
      #
      load_paths << %w(helpers controllers presenters views)
      ...
      #
      security.content_security_policy "default-src 'none'; script-src 'self' 'unsafe-inline'; connect-src 'self'; img-src 'self' http: https: data:; style-src 'self' 'unsafe-inline' fonts.googleapis.com; font-src 'self' data: fonts.gstatic.com;"
      ...
      controller.prepare do
        ...
        # before :authenticate!    # run an authentication before
